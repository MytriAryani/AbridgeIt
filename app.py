...
st.title("AbridgeIt!")
st.subheader("📌 Never lose track of meeting outcomes again.")
st.write("AbridgeIt is a smart, autonomous AI meeting assistant that transforms raw meeting transcripts into clear, professional summaries and actionable task lists. Designed for team leads and professionals, it ensures accountability by enabling easy email sharing — so everyone stays aligned on what needs to be done.")
